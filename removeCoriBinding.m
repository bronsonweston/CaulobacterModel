function [] = removeCoriBinding(celltype,CtrAExpProf,k)
...
%     try
        nameofFile=strcat(CtrAExpProf,'_',celltype);
        nameofFile=strcat(nameofFile,'.mat');
%     catch
%         nameofFile='tempname.mat';
%     end
    fullFileName = fullfile('ParamCatalog/ChangingBindingSims', nameofFile);
    TotalEvals=k-counter;
    save(fullFileName,'TotalEvals','change_tchromList','orig_tchromList','change_tdivList','orig_tdivList','tchromDifList','tdivDifList')
end
