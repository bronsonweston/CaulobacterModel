function [] = graphCellCycle(tout, teout, ieout, yout,cellCycleIniTimes, param, celltype, Screen)
...
%         dpCpdRtot
    ...
    if strcmp(Screen,'2screen left')
        set(gcf, 'Outerposition', [-1300 100 1280 800]);
    elseif strcmp(Screen,'2screen right')
        set(gcf, 'Outerposition', [2000 100 1280 800]);
    else
        set(gcf, 'Outerposition', [100 50 1280 800]);
    end
