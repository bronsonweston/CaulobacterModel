...
%&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&%
function [value,isterminal,direction] = events5(t, y)
global Timer
...
%0.36
value=[sign(Cori - 0.99); sign(Elong - 0.25); sign(Elong - 0.36); sign(Elong - 0.615); sign(Elong-1); sign(t-(Timer+20)); sign(-1*Zring-0.05); sign(Elong - 0.75);sign(Cori - 0.999); sign(CcrM-0.65)];
